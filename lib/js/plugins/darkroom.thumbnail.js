;(function(Darkroom, fabric, document) {
  ...
  function getImplementation(_this) {
    ...
    var states = {
      ...
      active: function() {
        ...
        Darkroom.Utils.cloneImage(image, function(clonedImage) { _this.originalImage = clonedImage; });
        ...
        Darkroom.Utils.forEachValue(inputs, function(input) { input.value = ''; });
        Darkroom.Utils.forEachValue(inputs, Darkroom.Utils.showElement);
      },
      ...
      notActive: function() {
        ...
        Darkroom.Utils.forEachValue(inputs, Darkroom.Utils.hideElement);
      }
    };
  ...
  Darkroom.plugins['thumbnail'] = Darkroom.Plugin.extend({
    ...
    initialize: function() {
      ...
      buttons.accept    = buttonGroup.createButton({image: 'done', type: 'success',hide: true});
      buttons.cancel    = buttonGroup.createButton({image: 'close', type: 'danger',hide: true});

      inputs.scale = Darkroom.Utils.createElement('input', {
        placeholder: 'Scale',
        style:       'width: 4em;',
        title:       'Scale',
        type:        'number',
      ...
      inputs.keepAspectRatio = Darkroom.Utils.createElement('input', {
        autocomplete: 'off',
        style:        'width: 4em;',
