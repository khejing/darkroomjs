;(function(Darkroom, fabric, document) {
  ...
  function getImplementation(_this) {
    ...
    var eventListeners = {
      ...
      accept: function() {
        ...
        Darkroom.Utils.makeStatic(watermark);
        ...
        fabric.Image.fromURL(canvas.toDataURL(), function(newImage) {
          ...
          Darkroom.Utils.makeStatic(newImage);
  ...
  Darkroom.plugins['watermark'] = Darkroom.Plugin.extend({
    ...
    initialize: function() {
      ...
      buttons.reject    = buttonGroup.createButton({image: 'close', type: 'danger', hide: true});

      inputs.text = Darkroom.Utils.createElement('input', {
        placeholder: 'Text',
        title:       'Text',
        type:        'text',
      ...
      inputs.color = Darkroom.Utils.createElement('input', {
        placeholder: 'Color',
        class: 'color',
        title: 'Color',
        size:  6,
      ...
      inputs.opacity = Darkroom.Utils.createElement('input', {
        placeholder: 'Opacity',
        style:       'width: 3em;',
        title:       'Opacity',
        type:        'number',
      ...
      inputs.font = Darkroom.Utils.createElement('select', {title: 'Font'});
